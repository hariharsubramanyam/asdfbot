...
public class SMConstants {
	...
	public final static int SATTACKGROUPFORMEDTRANSITION = -5;
	...
	public static Transition getTransition(StateMachine rootSM, int transitionVal){
		...
		case SATTACKGROUPFORMEDTRANSITION: return new SAttackGroupFormedTransition(rootSM);
		default: return null;
		}
	}
	...
	public static int[] getTransitionsForState(int stateID){
		...
		case SBUILDSTATE: return new int[]{SBUILDNUKETRANSITION,SATTACKGROUPFORMEDTRANSITION};
